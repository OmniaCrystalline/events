...
const Pagination = () => {
  ...
  const lastPage = sm ? Math.ceil(list.length / 6) : Math.ceil(list.length / 8);
  const handleClick = () => {
    window.scrollTo({
      top: 0,
      behavior: "smooth",
  ...
  return (
    <div className='pag_container' onClick={handleClick}>
      ...
      <button
        onClick={() => {
          disp(setCurrantPage(curr > 1 ? curr - 1 : 1));
        }}
        data-val='prev'
        className='pag_btn'>
        <Chevron />
      ...
      <button
        data-val='next'
        disabled={curr + 1 > lastPage}
        onClick={() => {
          disp(setCurrantPage(curr + 1));
        }}
        className='pag_btn'>
        {curr + 1}
      </button>
      <button
        disabled={curr + 2 > lastPage}
        onClick={() => {
          disp(setCurrantPage(curr + 2));
        }}
        data-val='step2'
      ...
      <button
        disabled={curr + 5 > lastPage}
        data-val='step5'
        onClick={() => {
          disp(setCurrantPage(curr + 5));
        }}
        className='pag_btn'>
        ...
      </button>
